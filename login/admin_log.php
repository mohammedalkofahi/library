		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="admin_log.php" class="signin-form" method="post">
		      		<div class="form-group">
...
if($con -> connect_error){
  die ("not connected " .$con -> connect_error);
	...
	$sql ="SELECT * FROM admins WHERE name ='$username1' AND password='$password1'";
	$ko = $con -> query($sql);
	
	if($ko -> num_rows > 0){
			
		echo "ok";
        header('Location: ../adminservices/admin_page.html');
        exit;

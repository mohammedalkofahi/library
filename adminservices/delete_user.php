...
if($con -> connect_error){
  die ("not connected " .$con -> connect_error);
	...
	if($ko -> num_rows > 0){
		$kk="DELETE FROM users WHERE name ='$username1' AND password='$password1'";
        $con -> multi_query($kk);
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="delete_user.php" class="signin-form" method="post">
		      		<div class="form-group">
	            ...
	            <div class="form-group">
	            	<button type="submit" class="form-control btn btn-primary submit px-3">delete account</button><br>
